...
const catDrop= document.querySelector('.icon-drop')
const catDisp= document.querySelector('.submenu-cat')
...
catDisp.style.display= catDrop.classList.contains('active')? 'block':'none'
})

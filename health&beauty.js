const firebaseConfig = {
  ...
  loadSection('blockI', 'TopDealsHealthBeauty')
  loadSection('blockII', 'Perfumes_FragranceHealthBeauty')
  loadSection('blockIII', 'NiveaOfficialStoreHealthBeauty')
  loadSection('blockIV', 'SkinRoutineHealthBeauty')
  loadSection('blockV', 'PersonalCareRoutineHealthBeauty')
  loadSection( 'blockVI', 'HairCareRoutineHealthBeauty')
  loadSection('blockVII', 'UnileverHealthBeauty')

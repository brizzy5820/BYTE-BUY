const firebaseConfig = {
  ...
  loadSection('blockI', 'LimitedStockDealsAppliances')
  loadSection('blockII', 'TopDealsHomeAppliances')
  loadSection('blockIII', 'TopDealsCookingAppliances')
  loadSection('blockIV', 'TopDealsKitchenAppliances')
  loadSection('blockV', 'TopDealsHeating_Cooling')
  loadSection( 'blockVI', 'BinatoneOfficialStore')
  loadSection('blockVIII', 'TopDealsLargeAppliances')
// loadSection('advertI', 'ApplianceCateogry')
